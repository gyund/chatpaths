...
interface CollectionOperations {
    ...
    suspend fun getPathCollections(
        userId: Int,
        enabledOnly: Boolean,
    ): List<PathCollection>
    ...
    suspend fun setCollectionTitle(
        collectionId: Int,
        title: String,
    )
    ...
    suspend fun setCollectionIsVisible(
        userId: Int,
        collectionId: Int,
        enabled: Boolean,
    )
    ...
    suspend fun setCollectionAutoSort(
        userId: Int,
        collectionId: Int,
        enabled: Boolean,
    )

    suspend fun setCollectionPathOrderToDefault(
        userId: Int,
        pathCollectionId: Int,
    )

    suspend fun updateCollectionOrder(
        userId: Int,
    ...
    suspend fun incrementPathCount(
        userId: Int,
        pathCollectionId: Int,
        pathId: Int,
    )
