...
class MigrationTest {
    ...
    fun populate11(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("INSERT INTO \"PathCollection\" VALUES (1,'col_title_smartchat',NULL,'ic_chat',NULL,2,0),\n" +
        ...
        db.execSQL("INSERT INTO \"PathToCollections\" VALUES (1,1,1,NULL,1),\n" +
                    " (2,1,2,NULL,2),\n" +
                    " (3,1,3,NULL,3),\n" +
                    " (4,1,4,2,NULL),\n" +
                    " (5,1,5,2,NULL),\n" +
        ...
        db.execSQL("INSERT INTO \"PathUser\" VALUES (1,'default',NULL),\n" +
                    " (2,'user1',NULL),\n" +
                    " (3,'user2',NULL);\n"
        )
        db.execSQL("INSERT INTO \"UserPathCollectionPrefs\" VALUES (1,1,1,1,NULL,0),\n" +
                    " (2,1,2,1,NULL,0),\n" +
                    " (3,1,3,1,NULL,0),\n" +
                    " (4,1,4,1,NULL,0),\n" +
                    " (5,1,6,1,NULL,0),\n" +
    ...
    @Test
    fun migrateAll() {
        for (version in 10..AppDatabase.DATABASE_VERSION) {
...
//                }
            ...
            Room.databaseBuilder(
                ...
                return@let AppDatabase.buildDatabase(it)
            }.apply {
                val data = LocalCPDataSource(this)
                when(version) {
//                    10 -> {
//                        runBlocking {
