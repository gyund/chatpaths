...
class SomethingsWrong (collection: Collection
) : Path (collection) {
    ...
    init {
        ...
        addChild(path().setName(R.string.path_something_hurts).setIcon(R.drawable.ic_something_hurts)
            ...
            .addChild(path().setName(R.string.path_mouth_teeth_tongue).setIcon(R.drawable.ic_mouth_teeth_tongue)
            ...
            .addChild(path().setName(R.string.path_leg_foot_knees_toes).setIcon(R.drawable.ic_leg_foot_knees_toes)
        ...
        addChild(path().setName(R.string.path_uncomfortable).setIcon(R.drawable.ic_hot)
